package com.nicko.jobportal.aspects;

import com.nicko.jobportal.dto.RegisterRequestDto;
import com.nicko.jobportal.entity.JobPortalUser;
import com.nicko.jobportal.exception.RegistrationValidationException;
...
public class RegisterValidationAspect {
    ...
    @Before("""
        execution(* com.nicko.jobportal.auth.AuthController
        .registerUser(..))
        """)
